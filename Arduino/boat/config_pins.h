...
#define RADIO_PWM1_IN 14     // GPIO 21 - PWM1 IN (CH4) - Aileron depuis radiocommande
#define RADIO_PWM2_IN 22     // GPIO 22 - PWM2 IN (CH2) - Safran depuis radiocommande
#define RADIO_SEL_IN 21      // GPIO 21 - SEL IN (CH6) - Sélection mode (0=autonome, 1=radiocommande)
                              // NOTE: GPIO 23 est utilisé pour LoRa RST sur TTGO T-Beam V1.1
                              // IMPORTANT: Si votre matériel est câblé sur GPIO 23, 
                              // vous devez déplacer le câble vers GPIO 21
