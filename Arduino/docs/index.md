...
!!! note "Portée de cette documentation"
    Cette documentation couvre uniquement la **partie embarquée** du projet AutoBoat, développée par **Mohamed Eljily**. Le projet AutoBoat contient plusieurs parties, et cette documentation se concentre spécifiquement sur le système embarqué.
...
![Composants du voilier autonome](images/boat-components.png)
